...
setup(
    ...
    url='https://github.com/brazil-data-cube/storm-hasher',
    project_urls={
        'Repository': 'https://github.com/brazil-data-cube/storm-hasher',
        'Issues': 'https://github.com/brazil-data-cube/storm-hasher/issues',
