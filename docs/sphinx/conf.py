...
"""Configuration file for the Checksum helper library for Storm platform documentation.
...
project = 'STORM_HASHER'
copyright = '2021, INPE.'
author = 'Brazil Data Cube Team'
release = storm_hasher.__version__
...
html_title = 'STORM_HASHER'

html_context = {
    'display_github': False,
    'github_user': 'brazil-data-cube',
    'github_repo': 'storm-hasher',
    'last_updated': False,
    #'commit': False,
}
...
#import os
#
#STORM_HASHER_EXAMPLE_URL = os.getenv('STORM_HASHER_EXAMPLE_URL', None)
#'''
